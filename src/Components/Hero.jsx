...
const Hero = () => {
  return (
    <div className="relative h-screen">
      ...
      >
        <div className="relative h-full max-md:h-screen">
      ...
      <div className="absolute inset-0 flex flex-col justify-center items-center text-center text-[#ffd700] p-4  max-md:p-0">
        <h1 className="text-6xl font-black mb-4 max-sm:text-xl">Welcome to My Blog App</h1>
